...
const Footer = () => {
  return (
    <>
      <section className="footermain text-left  w-full h-auto  bg-[#331C00] overflow-auto">
      <div className="footer text-left flex flex-col  lg:flex-row w-full  pl-[79.5px] pr-[79.5px] pt-[50px] lg:pb-[80px] bg-[#331C00] gap-[100px]">
