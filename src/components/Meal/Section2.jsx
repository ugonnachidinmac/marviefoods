...
const Section2 = () => {
  return (
    <>
     <section className="pl-[24px] pr-[24px] lg:pl-[80px] lg:mb-[120px] lg:pr-[80px]  font-'Red Hat Display' flex flex-col lg:flex-row gap-[10px] justify-center items-center ">
        
        <div className='bg-white w-[320px] h-[400px] rounded-[20px]'>
        <div className='flex flex-col justify-center items-center pt-[54px] pb-[54px] pl-[46px] pr-[46px]'>
        ...
        <div className='bg-[#FF8C00] w-[320px] h-[400px] rounded-[20px]'>
            <div className='flex flex-col justify-center items-center pt-[54px] pb-[54px] pl-[46px] pr-[46px]'>
